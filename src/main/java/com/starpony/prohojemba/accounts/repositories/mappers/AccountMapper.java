package com.starpony.prohojemba.accounts.repositories.mappers;
...
public interface AccountMapper {
    ...
    @Results({
            ...
            @Result(property = "permissions", column = "id", javaType = List.class,
                    many = @Many(select = "com.starpony.prohojemba.permissions.reposiitories.mappers.PermissionMapper.selectByAccount", fetchType = FetchType.LAZY))
    })
